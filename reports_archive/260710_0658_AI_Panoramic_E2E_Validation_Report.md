...
|---|---|---|---|
| Caries Detection | `chemahc94/Dental_002` | `best.pt`, `best_refined.pt` | ~19MB |
...
#### [치아별 치조골 소실 개별 실측 상세]
- 계측된 치아 없음 (무치악, 미탐지, 또는 모두 정상/치은염)
...
#### [치아별 치조골 소실 개별 실측 상세]
- 해당 환자는 소아(혼합치열기)로 판단되어 치조골 평가 대상에서 완전히 제외되었습니다. (표 생략)
...
rootdir: C:\Users\chema\Github\AI_Panoramic_Radiograph_Reader-\modules\Dental_003_bone_loss
configfile: pyproject.toml
plugins: anyio-4.11.0, hydra-core-1.3.2, cov-7.1.0, mock-3.15.1
collecting ... collected 6 items

modules\Dental_003_bone_loss\tests\test_evaluator.py::test_evaluator_metrics PASSED [ 16%]
modules\Dental_003_bone_loss\tests\test_geometry.py::test_calculate_distance PASSED [ 33%]
modules\Dental_003_bone_loss\tests\test_geometry.py::test_calculate_rbl_normal PASSED [ 50%]
modules\Dental_003_bone_loss\tests\test_geometry.py::test_calculate_rbl_clamped PASSED [ 66%]
modules\Dental_003_bone_loss\tests\test_staging.py::test_staging_stage_i_localized PASSED [ 83%]
modules\Dental_003_bone_loss\tests\test_staging.py::test_staging_stage_iv_generalized PASSED [100%]
...
platform win32 -- Python 3.11.9, pytest-9.0.3, pluggy-1.6.0 -- C:\Users\chema\AppData\Local\Microsoft\WindowsApps\PythonSoftwareFoundation.Python.3.11_qbz5n2kfra8p0\python.exe
cachedir: .pytest_cache
rootdir: C:\Users\chema\Github\AI_Panoramic_Radiograph_Reader-\modules\Dental_002_caries_detection
configfile: pyproject.toml
plugins: anyio-4.11.0, hydra-core-1.3.2, cov-7.1.0, mock-3.15.1
collecting ... collected 8 items

modules\Dental_002_caries_detection\tests\test_core.py::test_apply_clahe PASSED     [ 12%]
modules\Dental_002_caries_detection\tests\test_core.py::test_assign_quadrant PASSED [ 25%]
modules\Dental_002_caries_detection\tests\test_core.py::test_map_detections_to_quadrants PASSED [ 37%]
modules\Dental_002_caries_detection\tests\test_core.py::test_caries_detector_init PASSED [ 50%]
modules\Dental_002_caries_detection\tests\test_data_converter.py::test_coco_to_yolo_bbox_normal PASSED [ 62%]
modules\Dental_002_caries_detection\tests\test_data_converter.py::test_coco_to_yolo_bbox_clipping_negative PASSED [ 75%]
modules\Dental_002_caries_detection\tests\test_data_converter.py::test_coco_to_yolo_bbox_clipping_overflow PASSED [ 87%]
modules\Dental_002_caries_detection\tests\test_data_converter.py::test_coco_to_yolo_bbox_zero_size PASSED [100%]
